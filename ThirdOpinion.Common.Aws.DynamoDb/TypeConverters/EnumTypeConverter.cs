...
public class EnumConverter<T> : IPropertyConverter where T : struct, Enum
{
    ...
    public object FromEntry(DynamoDBEntry entry)
    {
        ...
        if (!Enum.TryParse(typeof(T), (string)primitive.Value, out object? result))
...
public class NullableEnumConverter<T> : IPropertyConverter where T : struct, Enum
{
    ...
    public DynamoDBEntry ToEntry(object value)
    {
        ...
        if (value.GetType() == typeof(T?))
        {
            ...
            object? enumValue = valueProperty?.GetValue(value);
    ...
    public object FromEntry(DynamoDBEntry entry)
    {
        object? result = _enumConverter.FromEntry(entry);
        if (result == null)
            return null!;
