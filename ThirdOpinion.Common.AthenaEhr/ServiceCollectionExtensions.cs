...
{
    public static IServiceCollection AddAthenaEhr(this IServiceCollection services,
        IConfiguration configuration)
    {
        ...
        services.AddHttpClient<IAthenaOAuthService, AthenaOAuthService>("AthenaOAuth",
