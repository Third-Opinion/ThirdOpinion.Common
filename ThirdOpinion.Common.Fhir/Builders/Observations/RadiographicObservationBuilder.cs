...
/// </summary>
public class RadiographicObservationBuilder : AiResourceBuilderBase<Observation, RadiographicObservationBuilder>
{
    ...
    private void BuildDerivedFromReferences(Observation observation)
    {
        ...
        allDerivedFrom.AddRange(EvidenceReferences);
