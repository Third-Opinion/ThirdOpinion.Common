...
public class AdtStatusObservationBuilder : AiResourceBuilderBase<Observation>
{
    ...
    /// <returns>This builder instance for method chaining</returns>
    public new AdtStatusObservationBuilder WithCriteria(string id,
        string display,
        string? system = null)
    {
    ...
    /// <returns>This builder instance for method chaining</returns>
    public AdtStatusObservationBuilder AddEvidence(ResourceReference reference,
        string? display = null)
    {
        if (reference != null) _evidenceReferences.Add((reference, display ?? reference.Display));
        return this;
    }
    ...
    protected override Observation BuildCore()
    {
        ...
        if (_evidenceReferences.Any() || DerivedFromReferences.Any())
        {
            ...
            foreach ((ResourceReference reference, string? display) in _evidenceReferences)
            {
                if (!string.IsNullOrWhiteSpace(display) &&
                    string.IsNullOrWhiteSpace(reference.Display)) reference.Display = display;
