...
## Purpose
This library provides services for downloading and organizing FHIR DocumentReference content from AWS HealthLake to S3 storage, with comprehensive metadata extraction and file organization capabilities.
