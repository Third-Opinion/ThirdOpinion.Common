...
public interface ITransactionLogService
{
    ...
    Task LogTransactionAsync(TransactionLogEntry entry, CancellationToken cancellationToken = default);
    ...
    Task<IEnumerable<TransactionLogEntry>> GetTransactionsAsync(string runId, CancellationToken cancellationToken = default);
    ...
    Task<IEnumerable<TransactionLogEntry>> GetTransactionsByDateRangeAsync(DateTime fromDate, DateTime toDate, CancellationToken cancellationToken = default);
    ...
    Task ExportToCsvAsync(string filePath, string? runId = null, CancellationToken cancellationToken = default);
    ...
    /// <param name="cancellationToken">Cancellation token</param>
    /// <returns>Task representing the async export operation</returns>
    Task ExportToJsonAsync(string filePath, string? runId = null, CancellationToken cancellationToken = default);
    ...
    Task<TransactionSummary> GetTransactionSummaryAsync(string? runId = null, CancellationToken cancellationToken = default);
...
public class TransactionSummary
{
    ...
    /// </summary>
    public double SuccessRate => TotalTransactions > 0 ? (SuccessfulTransactions * 100.0) / TotalTransactions : 0.0;
