...
public interface IBedrockPricingService
{
    ...
    BedrockCostCalculation CalculateCost(string modelId, int inputTokens, int outputTokens, string? region = null);
...
public class BedrockPricingService : IBedrockPricingService
{
    private static readonly Dictionary<string, BedrockModelPricing> ModelPricing = new()
    {
        ...
        ["anthropic.claude-sonnet-4-5-20250929-v1:0"] = new()
        {
        ...
        ["us.anthropic.claude-sonnet-4-5-20250929-v1:0"] = new()
        {
        ...
        ["anthropic.claude-haiku-4-5-20250929-v1:0"] = new()
        {
        ...
        ["us.anthropic.claude-haiku-4-5-20250929-v1:0"] = new()
        {
        ...
        ["anthropic.claude-opus-4-1-20250805-v1:0"] = new()
        {
        ...
        ["us.anthropic.claude-opus-4-1-20250805-v1:0"] = new()
        {
        ...
        ["anthropic.claude-3-5-sonnet-20240620-v1:0"] = new()
        {
        ...
        ["us.anthropic.claude-3-5-sonnet-20241022-v2:0"] = new()
        {
        ...
        ["anthropic.claude-3-opus-20240229-v1:0"] = new()
        {
        ...
        ["us.anthropic.claude-3-opus-20240229-v1:0"] = new()
        {
        ...
        ["anthropic.claude-3-haiku-20240307-v1:0"] = new()
        {
        ...
        ["us.anthropic.claude-3-haiku-20240307-v1:0"] = new()
        {
        ...
        // Amazon Titan Models
        ["amazon.titan-text-express-v1"] = new()
        {
        ...
        ["amazon.titan-embed-text-v1"] = new()
        {
        ...
        ["meta.llama3-2-3b-instruct-v1:0"] = new()
        {
        ...
        ["us.meta.llama3-2-3b-instruct-v1:0"] = new()
        {
    ...
    public BedrockCostCalculation CalculateCost(string modelId, int inputTokens, int outputTokens, string? region = null)
    {
        var pricing = GetModelPricing(modelId, region);
        ...
        var inputCost = (inputTokens / 1000m) * pricing.InputTokensPer1K;
        var outputCost = (outputTokens / 1000m) * pricing.OutputTokensPer1K;
    ...
    public BedrockModelPricing? GetModelPricing(string modelId, string? region = null)
    {
        ...
        if (normalizedModelId != modelId && ModelPricing.TryGetValue(normalizedModelId, out var normalizedPricing))
            return normalizedPricing;

        // Try to find base model without region prefix
        var baseModelId = RemoveRegionPrefix(modelId);
        if (baseModelId != modelId && ModelPricing.TryGetValue(baseModelId, out var basePricing))
            return basePricing;
    ...
    private static string NormalizeModelId(string modelId)
    {
        ...
        var normalized = modelId.ToLowerInvariant().Trim();
        ...
        var mappings = new Dictionary<string, string>
        {
            ...
            // Claude 3.x mappings
            ["us.anthropic.claude-3-5-sonnet-20241022-v2:0"] = "anthropic.claude-3-5-sonnet-20240620-v1:0",
        ...
        if (mappings.TryGetValue(normalized, out var mappedId))
            return mappedId;
