...
public class FhirResourceException : Exception
{
    ...
    public FhirResourceException(string message, Exception innerException) : base(message, innerException)
    {
    }

    public FhirResourceException(string message, string resourceType, string resourceId) : base(message)
    {
        ResourceType = resourceType;
        ResourceId = resourceId;
    }

    public FhirResourceException(string message, string resourceType, string resourceId, HttpStatusCode statusCode) 
        : base(message)
    {
        ResourceType = resourceType;
        ResourceId = resourceId;
    ...
    public FhirResourceException(string message, string resourceType, string resourceId, Exception innerException) 
...
public class FhirResourceNotFoundException : FhirResourceException
{
    public FhirResourceNotFoundException(string resourceType, string resourceId)
        : base($"FHIR resource not found: {resourceType}/{resourceId}", resourceType, resourceId, HttpStatusCode.NotFound)
    {
    }
}
