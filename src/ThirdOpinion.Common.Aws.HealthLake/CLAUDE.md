...
## Purpose
This library provides comprehensive services for interacting with AWS HealthLake FHIR datastores, including writing FHIR resources, managing HTTP operations with AWS authentication, and handling HealthLake-specific configurations.

## Core Components

### Main Services
- **HealthLakeFhirService** - Primary service for writing FHIR resources to HealthLake with version control and validation
