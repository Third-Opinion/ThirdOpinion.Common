...
public interface IFhirDestinationService
{
    ...
    Task PutResourceAsync(string resourceType, string resourceId, string resourceJson, CancellationToken cancellationToken = default);
    ...
    /// <param name="cancellationToken">Cancellation token</param>
    /// <returns>Task that completes when the resource is successfully written</returns>
    Task PutResourceAsync<T>(string resourceType, string resourceId, T resource, CancellationToken cancellationToken = default) where T : class;
    ...
    Task<WriteResult> WriteResourceAsync(string resourceJson, CancellationToken cancellationToken = default);
}
