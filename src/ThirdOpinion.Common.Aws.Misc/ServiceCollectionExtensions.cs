...
public static class ServiceCollectionExtensions
{
    ...
    public static IServiceCollection AddAwsMiscServices(this IServiceCollection services, IConfiguration configuration)
    {
        ...
        services.AddSingleton<IAmazonSecretsManager>(sp =>
        {
            ...
            return new AmazonSecretsManagerClient(Amazon.RegionEndpoint.GetBySystemName(config.Region));
        });
        ...
        Action<AwsMiscOptions> configureOptions)
    {
        ...
        services.AddSingleton<IAmazonSecretsManager>(sp =>
        {
            var region = options.SecretsManagerConfig?.Region
