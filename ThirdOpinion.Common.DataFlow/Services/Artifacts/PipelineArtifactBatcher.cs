...
/// <summary>
/// Storage-agnostic implementation of <see cref="IArtifactBatcher"/> that queues artifacts for batched persistence.
/// </summary>
public class PipelineArtifactBatcher : IArtifactBatcher
{
    private readonly IArtifactStorageService _storageService;
    private readonly ILogger<PipelineArtifactBatcher> _logger;
    ...
    public PipelineArtifactBatcher(
        IArtifactStorageService storageService,
        ILogger<PipelineArtifactBatcher> logger,
        int batchSize = 100,
