...
public interface IS3StorageService
{
    ...
    Task<bool> CheckFileExistsAsync(string bucket,
        string key,
    ...
    Task<bool> HandleForceOverwriteAsync(bool forceMode,
        string bucket,
        string key,
        CancellationToken cancellationToken = default);
    ...
    /// <exception cref="ArgumentException">Thrown when bucket or key is null or whitespace</exception>
    Task<S3FileInfo?> GetFileInfoAsync(string bucket,
        string key,
        CancellationToken cancellationToken = default);
    ...
    /// <exception cref="ArgumentException">Thrown when bucket or key is null or whitespace</exception>
    Task<bool> DeleteFileAsync(string bucket,
        string key,
        CancellationToken cancellationToken = default);
}